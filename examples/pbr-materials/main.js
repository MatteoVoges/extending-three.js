    ...
    new HDRCubeTextureLoader()
        ...
        .load( [ 'px.hdr', 'nx.hdr', 'py.hdr', 'ny.hdr', 'pz.hdr', 'nz.hdr' ],
            function ( texture ) {
                ...
                const geometries = [
                    new SuperquadricGeometry(0, 0, 64, 32).scale(0.8, 0.8, 0.8),
                    new SuperquadricGeometry(2, 2, 64, 32).scale(0.8, 0.8, 0.8),
                    new SuperquadricGeometry(0.8, 0.6, 32).scale(0.8, 0.8, 0.8),
                    new SuperquadricGeometry(4, 4, 64, 32).scale(0.8, 0.8, 0.8),
                ];
                ...
                mesh = new THREE.Mesh( geometries[1], material );
                mesh.position.x = 1;
                mesh.position.y = 1;
                group.add( mesh );
                ...
                mesh = new THREE.Mesh( geometries[2], material );
                mesh.position.x = 1;
                mesh.position.y = - 1;
                group.add( mesh );
                ...
                mesh = new THREE.Mesh( geometries[3], material );
                mesh.position.x = - 1;
                mesh.position.y = - 1;
                group.add( mesh );
